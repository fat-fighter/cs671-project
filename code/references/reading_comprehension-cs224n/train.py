...
def parse_arg():
    ...
    parser.add_argument('--lr', dest='learning_rate',
                        type=float, default=2e-3, help='learning_rate')
    parser.add_argument('--keep_prob', dest='keep_prob',
                        type=float, default=0.9, help='keep prob of dropout')
    parser.add_argument('--batch_size', dest='batch_size', type=int,
                        default=32, help='batch size to use during training.')
    parser.add_argument('--embed_size', dest='embed_size',
                        type=int, default=100, help='size of pretrained vocab')
    parser.add_argument('--state_size', dest='state_size',
                        type=int, default=64, help='size of each model layer')
    parser.add_argument('--optimizer', dest='optimizer',
                        type=str, default='adam')
    parser.add_argument('--output_dir', dest='output_dir',
                        type=str, default='outputs', help='directory of outputs')
    parser.add_argument('--reg', dest='reg', type=float,
                        default=0.001, help='rate of regularization')
    # if len(sys.argv) == 1:
    #     parser.print_help()
    #     sys.exit(1)
...
def main(_):
    ...
    embed_path = pjoin(data_dir, "glove.trimmed.300.npz")
